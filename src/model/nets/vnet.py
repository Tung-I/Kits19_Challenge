...
class OutputTransition(nn.Module):
    def __init__(self, inChans, outChans, elu, nll, acti=False):
...
class VNet(BaseNet):
    ...
    def __init__(self, in_channels, out_channels, elu=True, nll=False, acti=False):
        ...
        self.out_tr = OutputTransition(32, self.out_channels, self.elu, self.nll, self.acti)
